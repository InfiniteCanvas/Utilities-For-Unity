...
namespace InfiniteCanvas.Utilities.Extensions
{
	...
	#region ints
		...
		public static int RandomTo(this in int exclusiveMax, in int inclusiveMin = 0) => _random.NextInt(inclusiveMin, exclusiveMax);
		...
		/// <returns>Random number between [<see cref="inclusiveMin" />...<see cref="exclusiveMax" />]</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static int2 RandomTo(this in int2 exclusiveMax, in int2 inclusiveMin = default) => _random.NextInt2(inclusiveMin, exclusiveMax);
		...
		/// <returns>Random number between [<see cref="inclusiveMin" />...<see cref="exclusiveMax" />]</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static int3 RandomTo(this in int3 exclusiveMax, in int3 inclusiveMin = default) => _random.NextInt3(inclusiveMin, exclusiveMax);
		...
		/// <returns>Random number between [<see cref="inclusiveMin" />...<see cref="exclusiveMax" />]</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static int4 RandomTo(this in int4 exclusiveMax, in int4 inclusiveMin = default) => _random.NextInt4(inclusiveMin, exclusiveMax);
	...
	#region floats
		...
		/// <returns>Random number between [<see cref="inclusiveMin" />...<see cref="exclusiveMax" />]</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static float RandomTo(this in float exclusiveMax, in float inclusiveMin = 0) => _random.NextFloat(inclusiveMin, exclusiveMax);
		...
		/// <returns>Random number between [<see cref="inclusiveMin" />...<see cref="exclusiveMax" />]</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static float2 RandomTo(this in float2 exclusiveMax, in float2 inclusiveMin = default) => _random.NextFloat2(inclusiveMin, exclusiveMax);
		...
		/// <returns>Random number between [<see cref="inclusiveMin" />...<see cref="exclusiveMax" />]</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static float3 RandomTo(this in float3 exclusiveMax, in float3 inclusiveMin = default) => _random.NextFloat3(inclusiveMin, exclusiveMax);
		...
		/// <returns>Random number between [<see cref="inclusiveMin" />...<see cref="exclusiveMax" />]</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static float4 RandomTo(this in float4 exclusiveMax, in float4 inclusiveMin = default) => _random.NextFloat4(inclusiveMin, exclusiveMax);
